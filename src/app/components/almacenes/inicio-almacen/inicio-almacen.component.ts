...
@Component({
  selector: 'app-inicio-almacen',
  templateUrl: './inicio-almacen.component.html',
  styleUrls: ['./inicio-almacen.component.css']
})
export class InicioAlmacenComponent implements OnInit {
