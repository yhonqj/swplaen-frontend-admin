...
export class AdminService {
  ...
  registro_proveedor_admin(data: any, token: any): Observable<any> {
    ...
    return this._http.post(this.url + 'proveedor/add', data, { headers: headers });
  }
  ...
  eliminar_materia_prima(data: any, token: any): Observable<any> {
    let headers = new HttpHeaders({ 'Content-Type': 'application/json', 'token': token });
    return this._http.delete(this.url + 'materiaPrima/remove', { headers: headers, body: data });
  }
  ...
  obtener_proveedor_admin(id: any, token: any): Observable<any> {
    let headers = new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': token });
    return this._http.get(this.url + 'proveedor/getById?id=' + id, { headers: headers });
  }
